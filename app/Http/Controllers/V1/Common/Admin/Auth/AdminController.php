...
class AdminController extends Controller
{
	...
	{    
		...
		if($setting != null) {
			...
			foreach($request->only(['user_select_timeout', 'provider_select_timeout', 'provider_search_radius', 'unit_measurement', 'credit_ride_limit', 'manual_request', 'broadcast_request', 'ride_otp', 'booking_prefix']) as $key => $req) {
			...
			foreach($request->only(['store_search_radius', 'store_response_time', 'store_provider_select_timeout', 'store_manual_request', 'order_otp','store_booking_prefix','max_items_in_order']) as $key => $req) {
